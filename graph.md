- [图论](#图论)
	...
	- [图论基础](#图论基础)
		...
		- [欧拉路径 and 欧拉回路](#欧拉路径-and-欧拉回路)
		- [dfs树 and bfs树](#dfs树-and-bfs树)
	- [线段树优化建图](#线段树优化建图)
	- [最短路径](#最短路径)
		- [Dijkstra](#dijkstra)
		- [Floyd](#floyd)
	...
	- [树论](#树论)
		...
		- [树哈希](#树哈希)
	- [联通性相关](#联通性相关)
		- [强联通分量scc+缩点 using Tarjan](#强联通分量scc缩点-using-tarjan)
		- [边双连通分量 using Tarjan](#边双连通分量-using-tarjan)
		- [割点 / 割顶](#割点--割顶)
	- [2-sat问题](#2-sat问题)
	- [支配树 using Lengauer−Tarjan算法](#支配树-using-lengauertarjan算法)
	- [图上的NP问题](#图上的np问题)
...
- 最大独立集 = 顶点数 - 最大匹配
- DAG最小不相交路径覆盖 = （开点前）顶点数 - 最大匹配，右顶点未被匹配的都看作起点
- DAG最小相交路径覆盖 = 其传递闭包的DAG最小不相交路径覆盖
