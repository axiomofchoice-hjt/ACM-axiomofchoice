...
- [1. 并查集](#1-并查集)
  - [1.1. 朴素并查集](#11-朴素并查集)
  - [1.2. 种类并查集](#12-种类并查集)
  - [1.3. 可撤销种类并查集](#13-可撤销种类并查集)
  - [1.4. 可持久化并查集](#14-可持久化并查集)
- [2. 树状数组](#2-树状数组)
  - [2.1. 朴素树状数组](#21-朴素树状数组)
  - [2.2. 超级树状数组](#22-超级树状数组)
- [3. ST 表](#3-st-表)
  - [3.1. 朴素 ST 表](#31-朴素-st-表)
  - [3.2. 猫树](#32-猫树)
- [4. 单调队列](#4-单调队列)
- [5. 线段树](#5-线段树)
  - [5.1. 朴素线段树](#51-朴素线段树)
  - [5.2. 高拓展性线段树](#52-高拓展性线段树)
  - [5.3. 权值线段树（动态开点 线段树合并 线段树分裂）](#53-权值线段树动态开点-线段树合并-线段树分裂)
  - [5.4. ZKW 线段树](#54-zkw-线段树)
  - [5.5. 可持久化数组](#55-可持久化数组)
  - [5.6. 主席树](#56-主席树)
  - [5.7. 李超线段树](#57-李超线段树)
  - [5.8. 吉老师线段树 Segbeats](#58-吉老师线段树-segbeats)
- [6. 堆](#6-堆)
  - [6.1. 可删堆](#61-可删堆)
  - [6.2. 左偏树](#62-左偏树)
- [7. 平衡树](#7-平衡树)
  - [7.1. 无旋 Treap](#71-无旋-treap)
  - [7.2. 可持久化 Treap](#72-可持久化-treap)
  - [7.3. K-D Tree](#73-k-d-tree)
  - [7.4. Splay](#74-splay)
  - [7.5. 动态森林 using LCT](#75-动态森林-using-lct)
- [8. 莫队](#8-莫队)
  - [8.1. 普通莫队](#81-普通莫队)
  - [8.2. 带修莫队](#82-带修莫队)
  - [8.3. 回滚莫队](#83-回滚莫队)
- [9. 冷门数据结构](#9-冷门数据结构)
  - [9.1. 珂朵莉树 / 老司机树](#91-珂朵莉树--老司机树)
  - [9.2. 划分树](#92-划分树)
  - [9.3. 析合树](#93-析合树)
- [10. 造轮子](#10-造轮子)
  - [10.1. struct of 二维数组](#101-struct-of-二维数组)
  - [10.2. Hash 表](#102-hash-表)
