...
- [数学](#数学)
  - [数论](#数论)
    ...
    - [最大公约数](#最大公约数)
    - [CRT + extra](#crt--extra)
    - [离散对数 using BSGS + extra](#离散对数-using-bsgs--extra)
    - [阶与原根](#阶与原根)
    - [N 次剩余](#n-次剩余)
    - [数论函数](#数论函数)
      - [单个欧拉函数](#单个欧拉函数)
  ...
  - [多项式](#多项式)
    - [拉格朗日插值](#拉格朗日插值)
    - [快速傅里叶变换 / FFT + 任意模数](#快速傅里叶变换--fft--任意模数)
    - [多项式全家桶 数组版](#多项式全家桶-数组版)
    - [快速沃尔什变换 / FWT](#快速沃尔什变换--fwt)
    - [多项式复合](#多项式复合)
    - [多项式多点求值](#多项式多点求值)
    - [多项式快速插值](#多项式快速插值)
    - [k 进制异或卷积 / k 进制 FWT](#k-进制异或卷积--k-进制-fwt)
    - [任意长度 FFT using Bluestein 算法](#任意长度-fft-using-bluestein-算法)
    - [递推式插值 using BM 算法](#递推式插值-using-bm-算法)
    - [分治 FFT](#分治-fft)
    - [第二类斯特林数·行](#第二类斯特林数行)
  - [矩阵](#矩阵)
  ...
  - [数学杂项](#数学杂项)
    - [struct of 区间](#struct-of-区间)
    - [struct of 高精度](#struct-of-高精度)
    - [struct of 分数](#struct-of-分数)
    - [表达式求值](#表达式求值)
    - [数值积分 using 自适应辛普森法](#数值积分-using-自适应辛普森法)
