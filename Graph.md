...
- [1. 图论基础](#1-图论基础)
  - [1.1. 邻接表](#11-邻接表)
  - [1.2. 前向星](#12-前向星)
  - [1.3. 拓扑排序 / Toposort](#13-拓扑排序--toposort)
- [2. 线段树优化建图](#2-线段树优化建图)
- [3. 最短路径](#3-最短路径)
  - [3.1. 单源正权 using Dijkstra](#31-单源正权-using-dijkstra)
  - [3.2. 多源 using Floyd](#32-多源-using-floyd)
  - [3.3. 一般单源 using SPFA](#33-一般单源-using-spfa)
  - [3.4. 多源 using Johnson](#34-多源-using-johnson)
  - [3.5. n2 Dijkstra](#35-n2-dijkstra)
- [4. 最小生成树 / MST](#4-最小生成树--mst)
  - [4.1. Kruskal](#41-kruskal)
  - [4.2. Boruvka](#42-boruvka)
  - [4.3. n2 Prim](#43-n2-prim)
- [5. 树论](#5-树论)
  - [5.1. 树的直径](#51-树的直径)
  - [5.2. 树的重心](#52-树的重心)
  - [5.3. 最近公共祖先 / LCA](#53-最近公共祖先--lca)
    - [5.3.1. 树上倍增解法](#531-树上倍增解法)
    - [5.3.2. 欧拉序列建 ST 表解法](#532-欧拉序列建-st-表解法)
    - [5.3.3. 树链剖分解法](#533-树链剖分解法)
    - [5.3.4. Tarjan 解法](#534-tarjan-解法)
    - [5.3.5. 一些关于lca的问题](#535-一些关于lca的问题)
  - [5.4. 树链剖分](#54-树链剖分)
  - [5.5. 树分治](#55-树分治)
    - [5.5.1. 点分治](#551-点分治)
  - [5.6. 虚树](#56-虚树)
  - [5.7. 树上启发式合并](#57-树上启发式合并)
- [6. 联通性相关](#6-联通性相关)
  - [6.1. 强联通分量 SCC + 缩点](#61-强联通分量-scc--缩点)
  - [6.2. 边双连通分量 using Tarjan](#62-边双连通分量-using-tarjan)
  - [6.3. 割点 / 割顶](#63-割点--割顶)
- [7. 2-Sat 问题](#7-2-sat-问题)
- [8. 支配树 using Lengauer-Tarjan 算法](#8-支配树-using-lengauer-tarjan-算法)
- [9. 图上的NP问题](#9-图上的np问题)
  - [9.1. 最大团 and 极大团计数](#91-最大团-and-极大团计数)
  - [9.2. 最小染色数](#92-最小染色数)
- [10. 仙人掌 using 圆方树](#10-仙人掌-using-圆方树)
- [11. 二分图](#11-二分图)
  - [11.1. 二分图匹配 / 最大匹配](#111-二分图匹配--最大匹配)
  - [11.2. 二分图最大权匹配 using KM](#112-二分图最大权匹配-using-km)
  - [11.3. 稳定婚姻 using 延迟认可](#113-稳定婚姻-using-延迟认可)
  - [11.4. 一般图最大匹配 using 带花树](#114-一般图最大匹配-using-带花树)
  - [11.5. 一般图最大权匹配 using 带权带花树](#115-一般图最大权匹配-using-带权带花树)
- [12. 网络流](#12-网络流)
  - [12.1. 最大流 using Dinic](#121-最大流-using-dinic)
  - [12.2. 最小费用最大流 using MCMF](#122-最小费用最大流-using-mcmf)
  - [12.3. 上下界网络流](#123-上下界网络流)
- [13. 图论杂项](#13-图论杂项)
  - [13.1. Kruskal 重构树](#131-kruskal-重构树)
  - [13.2. DSU 重构树](#132-dsu-重构树)
...
## 8. 支配树 using Lengauer-Tarjan 算法
